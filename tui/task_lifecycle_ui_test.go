	...
	tests := []struct {
		...
		},
		{
			...
			messages: []tea.Msg{
				...
				clearLifecycleMsg{key: "init"},
				taskChangeMsg{task: newTestTaskWithFlows()},
				flowActionChangeMsg{action: domain.FlowAction{ActionType: "action_1", ActionStatus: domain.ActionStatusStarted}},
				flowActionChangeMsg{action: domain.FlowAction{ActionType: "action_1", ActionStatus: domain.ActionStatusComplete}},
				flowActionChangeMsg{action: domain.FlowAction{ActionType: "action_2", ActionStatus: domain.ActionStatusPending}},
			},
			wantProgress: true,
			wantContains: []string{
				"action_1",
		...
		},
		{
			...
			messages: []tea.Msg{
				...
				taskChangeMsg{task: newTestTaskWithFlows()},
				flowActionChangeMsg{action: domain.FlowAction{ActionType: "action_1", ActionStatus: domain.ActionStatusStarted}},
				flowActionChangeMsg{action: domain.FlowAction{ActionType: "action_1", ActionStatus: domain.ActionStatusFailed}},
