...
// set, git never falls back to ~/.gitconfig, so HOME needs no override. HOME
// must stay untouched anyway, since e2e tests in this package rely on
// devpod/openshell configuration stored under the real home directory.
