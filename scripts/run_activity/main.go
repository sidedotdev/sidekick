...
func buildActivityRegistry() map[string]interface{} {
	...
	standaloneFuncs := []interface{}{
		...
		env.ModalCreateSandboxActivity,
		env.ModalSyncRepoActivity,
		env.ModalCheckSandboxActivity,
		env.CreateModalWorktreeActivity,
		env.ModalDeleteActivity,
		env.ModalStopActivity,
