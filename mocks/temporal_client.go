...
//
// NOTE: the generated import of the internal package "go.temporal.io/sdk/internal"
// has been rewritten to the public "go.temporal.io/sdk/client" package, and the
// `internal.<Type>` qualifiers replaced with their public `client.<Alias>`
// equivalents, since importing the SDK's internal package is not allowed. The
// client package re-exports these types via aliases. Re-apply this rewrite when
// regenerating.
...
// CountActivities provides a mock function with given fields: ctx, options
...
// ExecuteActivity provides a mock function with given fields: ctx, options, activity, args
func (_m *Client) ExecuteActivity(ctx context.Context, options client.StartActivityOptions, activity interface{}, args ...interface{}) (client.ActivityHandle, error) {
	var _ca []interface{}
...
// GetActivityHandle provides a mock function with given fields: options
...
// ListActivities provides a mock function with given fields: ctx, options
func (_m *Client) ListActivities(ctx context.Context, options client.ListActivitiesOptions) (client.ListActivitiesResult, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, client.ListActivitiesOptions) (client.ListActivitiesResult, error)); ok {
		return rf(ctx, options)
	}
	...
	if rf, ok := ret.Get(1).(func(context.Context, client.ListActivitiesOptions) error); ok {
		r1 = rf(ctx, options)
	} else {
		r1 = ret.Error(1)
	}
