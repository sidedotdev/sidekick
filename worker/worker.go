...
func StartWorker(hostPort string, taskQueue string) *Worker {
	...
	w.RegisterActivity(env.CreateDevPodWorktreeActivity)
	...
	w.RegisterActivity(env.OpenShellCreateActivity)
	w.RegisterActivity(env.OpenShellSyncRepoActivity)
	w.RegisterActivity(env.OpenShellCheckSandboxActivity)
	w.RegisterActivity(env.CreateOpenShellWorktreeActivity)
	w.RegisterActivity(env.OpenShellDeleteActivity)
	w.RegisterActivity(env.OpenShellStopActivity)
	w.RegisterActivity(env.ModalCreateSandboxActivity)
	w.RegisterActivity(env.ModalSyncRepoActivity)
	w.RegisterActivity(env.ModalCheckSandboxActivity)
	w.RegisterActivity(env.CreateModalWorktreeActivity)
	w.RegisterActivity(env.ModalDeleteActivity)
	w.RegisterActivity(env.ModalStopActivity)
	...
	w.RegisterActivity(git.GetGitUserConfigActivity)
